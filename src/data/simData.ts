...
const rawProductos: Omit<Producto, 'estado'>[] = [
  // Medicamentos veterinarios
  { codigo: 'MD-1001', nombre: 'Producto Veterinario Bovino A', categoria: 'Medicamentos veterinarios', presentacion: 'Presentación comercial A', especie: 'Bovinos', laboratorio: 'VetPharma', stock: { siberia: 48, 'la-caro': 12, ubate: 0, simijaca: 5 }, rotacion: 'Alta', ultimoMovimiento: '2026-09-12' },
  { codigo: 'MD-1002', nombre: 'Producto Veterinario Bovino B', categoria: 'Medicamentos veterinarios', presentacion: 'Presentación comercial B', especie: 'Bovinos', laboratorio: 'AgroLab', stock: { siberia: 30, 'la-caro': 25, ubate: 18, simijaca: 0 }, rotacion: 'Media', ultimoMovimiento: '2026-09-08' },
  { codigo: 'MD-1003', nombre: 'Producto Veterinario Mixto C', categoria: 'Medicamentos veterinarios', presentacion: 'Presentación comercial C', especie: 'Ambos', laboratorio: 'VetPharma', stock: { siberia: 0, 'la-caro': 0, ubate: 0, simijaca: 0 }, rotacion: 'Media', ultimoMovimiento: '2026-08-28' },
  // Antiparasitarios
  { codigo: 'AP-2001', nombre: 'Antiparasitario Bovino Campo', categoria: 'Antiparasitarios', presentacion: 'Presentación comercial A', especie: 'Bovinos', laboratorio: 'Parasol', stock: { siberia: 60, 'la-caro': 40, ubate: 15, simijaca: 22 }, rotacion: 'Alta', ultimoMovimiento: '2026-09-14' },
  { codigo: 'AP-2002', nombre: 'Antiparasitario Bovino Plus', categoria: 'Antiparasitarios', presentacion: 'Presentación comercial B', especie: 'Bovinos', laboratorio: 'Parasol', stock: { siberia: 8, 'la-caro': 0, ubate: 0, simijaca: 3 }, rotacion: 'Alta', ultimoMovimiento: '2026-09-10' },
  { codigo: 'AP-2003', nombre: 'Antiparasitario Equino Campo', categoria: 'Antiparasitarios', presentacion: 'Presentación comercial C', especie: 'Equinos', laboratorio: 'EquiCare', stock: { siberia: 20, 'la-caro': 6, ubate: 0, simijaca: 0 }, rotacion: 'Media', ultimoMovimiento: '2026-09-05' },
  // Vacunas
  { codigo: 'VC-3001', nombre: 'Vacuna Bovina Línea Campo', categoria: 'Vacunas', presentacion: 'Caja multipresentación', especie: 'Bovinos', laboratorio: 'BioVacunas', stock: { siberia: 35, 'la-caro': 18, ubate: 10, simijaca: 8 }, rotacion: 'Alta', ultimoMovimiento: '2026-09-13' },
  { codigo: 'VC-3002', nombre: 'Vacuna Mixta Línea Campo', categoria: 'Vacunas', presentacion: 'Caja multipresentación', especie: 'Ambos', laboratorio: 'BioVacunas', stock: { siberia: 12, 'la-caro': 0, ubate: 0, simijaca: 0 }, rotacion: 'Media', ultimoMovimiento: '2026-09-01' },
  { codigo: 'VC-3003', nombre: 'Vacuna Equina Línea Campo', categoria: 'Vacunas', presentacion: 'Caja multipresentación', especie: 'Equinos', laboratorio: 'BioVacunas', stock: { siberia: 0, 'la-caro': 0, ubate: 0, simijaca: 0 }, rotacion: 'Baja', ultimoMovimiento: '2026-07-20' },
  // Antiinflamatorios
  { codigo: 'AI-4001', nombre: 'Antiinflamatorio Mixto Campo', categoria: 'Antiinflamatorios', presentacion: 'Presentación comercial A', especie: 'Ambos', laboratorio: 'VetPharma', stock: { siberia: 25, 'la-caro': 10, ubate: 8, simijaca: 4 }, rotacion: 'Media', ultimoMovimiento: '2026-09-11' },
  { codigo: 'AI-4002', nombre: 'Antiinflamatorio Bovino Campo', categoria: 'Antiinflamatorios', presentacion: 'Presentación comercial B', especie: 'Bovinos', laboratorio: 'AgroLab', stock: { siberia: 0, 'la-caro': 0, ubate: 0, simijaca: 0 }, rotacion: 'Media', ultimoMovimiento: '2026-08-25' },
  // Nutrición y suplementos
  { codigo: 'NS-5001', nombre: 'Suplemento Bovino Vital', categoria: 'Nutrición y suplementos', presentacion: 'Caja multipresentación', especie: 'Bovinos', laboratorio: 'NutriVet', stock: { siberia: 40, 'la-caro': 22, ubate: 15, simijaca: 10 }, rotacion: 'Alta', ultimoMovimiento: '2026-09-14' },
  ...
  { codigo: 'NS-5003', nombre: 'Suplemento Mineral Bovino', categoria: 'Nutrición y suplementos', presentacion: 'Presentación comercial C', especie: 'Bovinos', laboratorio: 'NutriVet', stock: { siberia: 5, 'la-caro': 0, ubate: 0, simijaca: 0 }, rotacion: 'Baja', ultimoMovimiento: '2026-06-15' },
  // Sales mineralizadas
  { codigo: 'SM-6001', nombre: 'Sal Mineralizada Bovina', categoria: 'Sales mineralizadas', presentacion: 'Saco 25kg', especie: 'Bovinos', laboratorio: 'MineralAndes', stock: { siberia: 80, 'la-caro': 50, ubate: 30, simijaca: 25 }, rotacion: 'Alta', ultimoMovimiento: '2026-09-15' },
  ...
  // Alimentos concentrados
  { codigo: 'AC-7001', nombre: 'Concentrado Lechero Premium', categoria: 'Alimentos concentrados', presentacion: 'Saco 40kg', especie: 'Bovinos', laboratorio: 'NutriBov', stock: { siberia: 120, 'la-caro': 60, ubate: 0, simijaca: 40 }, rotacion: 'Alta', ultimoMovimiento: '2026-09-15' },
  { codigo: 'AC-7002', nombre: 'Concentrado para Engorde', categoria: 'Alimentos concentrados', presentacion: 'Saco 40kg', especie: 'Bovinos', laboratorio: 'NutriBov', stock: { siberia: 90, 'la-caro': 45, ubate: 20, simijaca: 30 }, rotacion: 'Alta', ultimoMovimiento: '2026-09-14' },
  { codigo: 'AC-7003', nombre: 'Concentrado Equino Deportivo', categoria: 'Alimentos concentrados', presentacion: 'Saco 40kg', especie: 'Equinos', laboratorio: 'EquiCare', stock: { siberia: 25, 'la-caro': 0, ubate: 0, simijaca: 0 }, rotacion: 'Baja', ultimoMovimiento: '2026-07-10' },
  // Equipos e insumos pecuarios
  { codigo: 'EQ-8001', nombre: 'Jeringa de Aplicación Automática', categoria: 'Equipos e insumos pecuarios', presentacion: 'Unidad', especie: 'Ambos', laboratorio: 'AgroTools', stock: { siberia: 30, 'la-caro': 15, ubate: 8, simijaca: 6 }, rotacion: 'Media', ultimoMovimiento: '2026-09-09' },
...
export type TipoExplotacion = 'Ganadería de leche' | 'Ganadería de carne' | 'Doble propósito' | 'Cría de equinos' | 'Equinos deportivos' | 'Cría bovina';
...
export const clientes: Cliente[] = [
  {
    ...
    historialPedidos: [
      { id: 'P-1042', fecha: '2026-08-15', productos: [{ codigo: 'AC-7001', nombre: 'Concentrado Lechero Premium', cantidad: 20 }], total: 1800000, estado: 'Despachado' },
      { id: 'P-1038', fecha: '2026-07-20', productos: [{ codigo: 'AP-2001', nombre: 'Antiparasitario Bovino Campo', cantidad: 15 }], total: 450000, estado: 'Despachado' },
    ],
    categoriasCompradas: ['Alimentos concentrados', 'Antiparasitarios', 'Sales mineralizadas'],
    tareas: [{ id: 'T-001', descripcion: 'Enviar cotización de sal mineralizada', fechaLimite: '2026-09-18', completada: false }],
  ...
  },
  {
    ...
    historialVisitas: [
      { fecha: '2026-09-01', vendedor: 'Ana Ríos', notas: 'Revisión comercial de rutina. Cliente satisfecho. Solicita información de la línea bovina.', productosInteres: ['VC-3001'], realizada: true },
    ...
    historialPedidos: [
      { id: 'P-1050', fecha: '2026-09-05', productos: [{ codigo: 'SM-6001', nombre: 'Sal Mineralizada Bovina', cantidad: 10 }, { codigo: 'AP-2001', nombre: 'Antiparasitario Bovino Campo', cantidad: 20 }], total: 1200000, estado: 'Despachado' },
    ],
    ...
    recomendacionesIA: [
      'Cliente activo con buen historial. Conviene presentar la categoría de nutrición y suplementos, sujeta a validación profesional.',
  ...
  },
  {
    ...
    historialPedidos: [
      { id: 'P-1045', fecha: '2026-08-20', productos: [{ codigo: 'AP-2002', nombre: 'Antiparasitario Bovino Plus', cantidad: 8 }], total: 960000, estado: 'Despachado' },
    ],
    categoriasCompradas: ['Antiparasitarios'],
    tareas: [{ id: 'T-002', descripcion: 'Enviar cotización de la línea bovina solicitada', fechaLimite: '2026-09-17', completada: false }],
  ...
  },
  {
    ...
    notasVendedor: 'Cliente sin contacto desde junio. Criadero reconocido con potencial de compra recurrente.',
    recomendacionesIA: [
  ...
  },
  {
    ...
    historialVisitas: [
      { fecha: '2026-09-10', vendedor: 'Ana Ríos', notas: 'Visita de seguimiento. Cliente solicita información comercial de la línea antiparasitaria.', productosInteres: ['AP-2001', 'AP-2002'], realizada: true },
      { fecha: '2026-08-15', vendedor: 'Ana Ríos', notas: 'Entrega de concentrado lechero.', productosInteres: ['AC-7001'], realizada: true },
    ],
    historialPedidos: [
      { id: 'P-1052', fecha: '2026-09-12', productos: [{ codigo: 'AC-7001', nombre: 'Concentrado Lechero Premium', cantidad: 30 }], total: 2700000, estado: 'Despachado' },
    ],
    categoriasCompradas: ['Alimentos concentrados', 'Antiparasitarios'],
    tareas: [],
    notasVendedor: 'Cliente muy activo. Buenos volúmenes de concentrado. Potencial para ampliar el portafolio con acompañamiento profesional.',
    recomendacionesIA: [
      'Cliente activo con alta frecuencia de compra de concentrado lechero. Conviene presentar el portafolio complementario con acompañamiento profesional.',
      'Su historial registra compras recurrentes de la categoría antiparasitarios — programar seguimiento comercial.',
    ],
  },
  {
    ...
    historialPedidos: [
      { id: 'P-1010', fecha: '2026-06-10', productos: [{ codigo: 'AP-2001', nombre: 'Antiparasitario Bovino Campo', cantidad: 25 }], total: 750000, estado: 'Despachado' },
    ],
    categoriasCompradas: ['Antiparasitarios'],
  ...
  },
  {
    ...
    recomendacionesIA: [
      ...
      'Su historial muestra compras mensuales de la categoría de nutrición — programar seguimiento comercial.',
    ],
  },
  {
    ...
    historialPedidos: [
      { id: 'P-1040', fecha: '2026-08-10', productos: [{ codigo: 'SM-6001', nombre: 'Sal Mineralizada Bovina', cantidad: 15 }], total: 675000, estado: 'Despachado' },
    ],
  ...
  },
  {
    ...
    estadoComercial: 'Activo', proximaAccion: 'Visita programada para 17 sept', nivelRiesgo: 'Bajo',
    telefono: '310 555 0109', hectareas: 90, numAnimales: 65,
    historialVisitas: [
      { fecha: '2026-09-05', vendedor: 'Carlos Mendoza', notas: 'Cliente satisfecho. Programa visita para revisar necesidades del portafolio con el equipo técnico.', productosInteres: ['VC-3001', 'AP-2001'], realizada: true },
    ],
    historialPedidos: [
      { id: 'P-1051', fecha: '2026-09-08', productos: [{ codigo: 'AC-7002', nombre: 'Concentrado para Engorde', cantidad: 12 }], total: 960000, estado: 'Despachado' },
    ],
    ...
    recomendacionesIA: [
      'Cliente constante con compras mensuales. Conviene programar acompañamiento técnico y comercial para fidelizar.',
    ],
  },
  {
    ...
    historialPedidos: [
      { id: 'P-1005', fecha: '2026-05-01', productos: [{ codigo: 'VC-3001', nombre: 'Vacuna Bovina Línea Campo', cantidad: 30 }], total: 1350000, estado: 'Despachado' },
    ],
    ...
    recomendacionesIA: [
      ...
      'Su historial de compra abre una ventana comercial de seguimiento en octubre.',
    ],
  },
  {
    ...
    historialPedidos: [
      { id: 'P-1053', fecha: '2026-09-14', productos: [{ codigo: 'AC-7001', nombre: 'Concentrado Lechero Premium', cantidad: 15 }], total: 1350000, estado: 'En preparación' },
    ],
    categoriasCompradas: ['Alimentos concentrados', 'Antiparasitarios'],
    tareas: [],
  ...
  },
  {
    ...
    historialVisitas: [
      { fecha: '2026-07-10', vendedor: 'Laura Vega', notas: 'Cliente interesado en la línea de vacunas equinas. Producto agotado en ese momento.', productosInteres: ['VC-3003'], realizada: true },
    ],
    historialPedidos: [
      { id: 'P-1025', fecha: '2026-07-15', productos: [{ codigo: 'AP-2003', nombre: 'Antiparasitario Equino Campo', cantidad: 10 }], total: 400000, estado: 'Despachado' },
    ],
    categoriasCompradas: ['Antiparasitarios'],
    tareas: [{ id: 'T-007', descripcion: 'Notificar disponibilidad de la línea de vacunas equinas', fechaLimite: '2026-09-19', completada: false }],
    notasVendedor: 'Cliente interesado en la línea equina que estuvo agotada. Revisar disponibilidad.',
    recomendacionesIA: [
      'Cliente solicitó una referencia de la línea equina que sigue agotada en todas las sedes — oportunidad de pedido al proveedor.',
  ...
  },
  {
    ...
    historialPedidos: [
      { id: 'P-1046', fecha: '2026-08-25', productos: [{ codigo: 'SM-6001', nombre: 'Sal Mineralizada Bovina', cantidad: 20 }], total: 900000, estado: 'Despachado' },
    ],
  ...
  },
  {
    ...
    estadoComercial: 'Activo', proximaAccion: 'Visita preventa programada 18 sept', nivelRiesgo: 'Bajo',
    ...
    historialPedidos: [
      { id: 'P-1054', fecha: '2026-09-15', productos: [{ codigo: 'AC-7001', nombre: 'Concentrado Lechero Premium', cantidad: 25 }], total: 2250000, estado: 'Pendiente de confirmar' },
    ],
  ...
  {
    id: 'C-015', nombre: 'Ganadería El Palmar', tipoExplotacion: 'Cría bovina', municipio: 'Simijacá',
    ...
    historialPedidos: [
      { id: 'P-1015', fecha: '2026-06-15', productos: [{ codigo: 'VC-3001', nombre: 'Vacuna Bovina Línea Campo', cantidad: 40 }, { codigo: 'AP-2001', nombre: 'Antiparasitario Bovino Campo', cantidad: 30 }], total: 2400000, estado: 'Despachado' },
    ],
    categoriasCompradas: ['Vacunas', 'Antiparasitarios'],
    ...
    recomendacionesIA: [
      ...
      'La expansión reportada abre una oportunidad comercial en varias categorías, sujeta a validación profesional.',
    ],
  },
];
...
export const pedidos: Pedido[] = [
  {
    ...
    lineas: [{ codigo: 'AC-7001', nombre: 'Concentrado Lechero Premium', cantidad: 25, precioUnitario: 90000, sedeDespacho: 'siberia' }],
  ...
  },
  {
    ...
    lineas: [{ codigo: 'AC-7001', nombre: 'Concentrado Lechero Premium', cantidad: 15, precioUnitario: 90000, sedeDespacho: 'siberia' }],
  ...
  },
  {
    ...
    lineas: [{ codigo: 'AP-2003', nombre: 'Antiparasitario Equino Campo', cantidad: 10, precioUnitario: 40000, sedeDespacho: 'la-caro' }],
  ...
  },
  {
    ...
    lineas: [
      { codigo: 'SM-6001', nombre: 'Sal Mineralizada Bovina', cantidad: 20, precioUnitario: 45000, sedeDespacho: 'ubate' },
      { codigo: 'AP-2001', nombre: 'Antiparasitario Bovino Campo', cantidad: 15, precioUnitario: 30000, sedeDespacho: 'ubate' },
    ],
  ...
  },
  {
    ...
    estado: 'Pendiente de confirmar',
    lineas: [{ codigo: 'AC-7002', nombre: 'Concentrado para Engorde', cantidad: 30, precioUnitario: 80000, sedeDespacho: 'simijaca' }],
  ...
  },
  {
    ...
    estado: 'Despachado',
    lineas: [{ codigo: 'AC-7001', nombre: 'Concentrado Lechero Premium', cantidad: 30, precioUnitario: 90000, sedeDespacho: 'ubate' }],
  ...
  },
  {
    ...
    estado: 'Despachado',
    lineas: [{ codigo: 'AC-7002', nombre: 'Concentrado para Engorde', cantidad: 12, precioUnitario: 80000, sedeDespacho: 'simijaca' }],
  ...
  },
  {
    ...
    lineas: [
      ...
      { codigo: 'AP-2003', nombre: 'Antiparasitario Equino Campo', cantidad: 5, precioUnitario: 40000, sedeDespacho: 'siberia' },
    ],
...
export const visitas: Visita[] = [
  { id: 'V-001', clienteId: 'C-009', clienteNombre: 'Finca El Mirador', fecha: '2026-09-17', hora: '09:00', vendedor: 'Carlos Mendoza', municipio: 'Simijacá', estado: 'Programada', notas: 'Revisión técnica del portafolio con profesional autorizado.', productosInteres: ['VC-3001', 'AP-2001'] },
  ...
  { id: 'V-003', clienteId: 'C-014', clienteNombre: 'Finca Villa Helena', fecha: '2026-09-18', hora: '10:30', vendedor: 'Ana Ríos', municipio: 'Ubaté', estado: 'Programada', notas: 'Visita técnica y comercial de preventa.', productosInteres: ['VC-3001'] },
...
export const oportunidades: Oportunidad[] = [
  ...
  { id: 'O-003', tipo: 'Traslado de inventario', clienteNombre: 'Ubaté', sedeInvolucrada: 'ubate', valorPotencial: 0, prioridad: 'Alta', motivo: 'Ubaté tiene referencias agotadas que están disponibles en Siberia.', confianza: 100, accion: 'Aprobar traslado desde Siberia', responsable: 'Coordinación logística', estado: 'Abierta' },
  ...
  { id: 'O-006', tipo: 'Baja rotación', clienteNombre: 'La Caro', sedeInvolucrada: 'la-caro', valorPotencial: 0, prioridad: 'Media', motivo: 'Varias referencias presentan baja rotación en La Caro. Capital inmovilizado estimado.', confianza: 90, accion: 'Revisar referencias de baja rotación', responsable: 'Gerencia', estado: 'Abierta' },
...
export const notificaciones: Notificacion[] = [
  { id: 'N-001', tipo: 'alerta', titulo: 'Producto agotado', mensaje: 'Producto Veterinario Mixto C agotado en todas las sedes', fecha: '2026-09-15', leida: false },
  ...
  { id: 'N-005', tipo: 'alerta', titulo: 'Inventario bajo', mensaje: 'Antiparasitario Bovino Plus con stock crítico', fecha: '2026-09-14', leida: false },
];
...
export const actividadesRecientes: ActividadReciente[] = [
  ...
  { id: 'A-004', usuario: 'Ana Ríos', accion: 'Despachó pedido', detalle: 'P-2006 — Hacienda El Roble', hora: 'Ayer' },
...
export const trasladosSugeridos: TrasladoSugerido[] = [
  { id: 'TR-001', productoCodigo: 'MD-1001', productoNombre: 'Producto Veterinario Bovino A', sedeOrigen: 'siberia', sedeDestino: 'ubate', cantidad: 15, motivo: 'Ubaté agotado, Siberia tiene 48 unidades', estado: 'Sugerido' },
  { id: 'TR-002', productoCodigo: 'MD-1002', productoNombre: 'Producto Veterinario Bovino B', sedeOrigen: 'siberia', sedeDestino: 'simijaca', cantidad: 10, motivo: 'Simijacá agotado, Siberia tiene 30 unidades', estado: 'Sugerido' },
  { id: 'TR-003', productoCodigo: 'VC-3002', productoNombre: 'Vacuna Mixta Línea Campo', sedeOrigen: 'siberia', sedeDestino: 'la-caro', cantidad: 5, motivo: 'La Caro agotado, Siberia tiene 12 unidades', estado: 'Sugerido' },
  { id: 'TR-004', productoCodigo: 'AC-7001', productoNombre: 'Concentrado Lechero Premium', sedeOrigen: 'siberia', sedeDestino: 'ubate', cantidad: 30, motivo: 'Ubaté agotado, alta demanda en zona lechera', estado: 'Sugerido' },
...
export function getPrioridadesIA() {
  return [
    {
      id: 'PR-001',
      titulo: 'Clientes importantes superan el umbral de seguimiento comercial',
    ...
    {
      id: 'PR-002',
      titulo: 'Ubaté concentra referencias agotadas con disponibilidad en Siberia',
    ...
    {
      id: 'PR-003',
      titulo: 'Referencias de baja rotación requieren revisión en La Caro',
    ...
    {
      id: 'PR-004',
      titulo: 'Fincas en ventana de reposición requieren contacto preventivo',
